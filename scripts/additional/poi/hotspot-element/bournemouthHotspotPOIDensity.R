...
city <- aggregate(city)
crimesPath <- paste('../data/points-in-hotspots/bournemouth/', categoryName, '.csv', sep = '')
...
filePath <- paste("../data/points-in-hotspots/bournemouth/poi/", r, "/", categoryName, "_poi_dens_", r, ".csv", sep = '')
