...
city <- aggregate(city)
crimesPath <- paste('../data/points-in-hotspots/bialystokSWD/', categoryName, '.csv', sep = '')
...
filePath <- paste("../data/points-in-hotspots/bialystokSWD/poi-one/", r, "/", categoryName, "_poi_dens_", r, ".csv", sep = '')
