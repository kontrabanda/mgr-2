...
city <- aggregate(city)
crimesPath <- paste('../data/points-in-hotspots/olsztynSWD/', categoryName, '.csv', sep = '')
...
filePath <- paste("../data/points-in-hotspots/olsztynSWD/poi/", r, "/", categoryName, "_poi_dens_", r, ".csv", sep = '')
