...
city <- aggregate(city)
crimesPath <- paste('../data/hotspot-grid/bournemouth/', categoryName, '.csv', sep = '')
...
filePath <- paste("../data/hotspot-grid/bournemouth/poi-one/", r, "/", categoryName, "_poi_dens_", r, ".csv", sep = '')
