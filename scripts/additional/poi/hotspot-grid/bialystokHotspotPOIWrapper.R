...
city <- aggregate(city)
crimesPath <- paste('../data/cells-in-hotspots/bialystok/', categoryName, '.csv', sep = '')
...
filePath <- paste("../data/hotspot-grid/bialystok/poi/", r, "/", categoryName, "_poi_dens_", r, ".csv", sep = '')
